...
<div style="text-align: center;width:495px;height:100%;display:block; margin:0px auto 0px auto;" >
    ...
    <br/>
    <br/>
      <img src="<%=str %>/sys/barcode!writeCodeImage.action?code=${ycinfo.xtdabh }" /> 
     <br/><br/>
	...
	<div style="text-align: left;margin-left:180px;">
	    ...
	    <span>
	           ...
	           <c:forEach items="${ycPic_list }" var="pic"  varStatus="status">
	            <li style="line-height: 23px;list-style-type:none;">${status.index+1} &nbsp;&nbsp; ${paperMap[pic.takecode] }</li>
	           </c:forEach>
