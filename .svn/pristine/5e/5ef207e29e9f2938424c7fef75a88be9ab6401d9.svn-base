...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>system/login/img/login.css">
		        ...
		        <form action="login!login.action" name="form" method="post">
				    <table>
					  <tr>
					    ...
					    <td colspan="2"><input class="login_mid" name="userCode" type="text" id="userCode" value=""/></td>
					  </tr>
					  <tr>
					    <td class="login_left" align="right">密&nbsp;&nbsp;&nbsp;码</td> 
					    <td><input class="login_mid" type="password" name="password"  id="password" value=""/></td>
  ...
  &copy; CopyRight&nbsp;&nbsp;&nbsp; 2013-2023 &nbsp;&nbsp;&nbsp;北京精英智通科技股份有限公司  <span  style="font-size:12px;">设计开发</span>
<br><br>
