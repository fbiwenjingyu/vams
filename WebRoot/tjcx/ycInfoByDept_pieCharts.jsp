...
<div id="searchPanel" class="box2" panelTitle="外检数量柱状统计图查询" roller="false">
	<form action="ycInfoCharts!ycInfoByDept_pieCharts.action" method="post" name="queryForm">
    ...
    <td valign="top" class="text" align="center"> 
		<div id="chartdiv" align="center">  </div>
      	<script type="text/javascript">
		   	var chart = new FusionCharts("fusionCharts/Pie3D.swf", "ChartId", "800", "450", "0", "0");
		   	var dataXml = "<chart palette='2' caption='外检信息数量饼状分布统计图(审核通过的计入统计)' xAxisName=''  showBorder='1' showValues='1' enableRotation='0' bgColor='99CCFF,FFFFFF' bgAlpha='40,100' bgRatio='0,100' decimals='0' formatNumberScale='0' baseFont='Arial' baseFontSize ='12' shownames='1'>";
