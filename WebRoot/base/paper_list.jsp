...
String preActoin = "paper";
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>档案页设置查询列表页面</title>
<%@ include file="/common/meta.jsp"%>
<%@ include file="/common/taglib.jsp"%>
<script language="javascript">
        	function add(){
                var url="<%=path %>/base/paper_add.jsp";
        		top.Dialog.open({URL:url,Title:"档案页添加"});
           	}
            ...
            function update(id){   
                ...
                top.Dialog.open({URL:url,Title:"档案页修改"});
...
<div id="searchPanel" class="box2" panelTitle="档案页设置查询" roller="false">
	<form action="<%=preActoin %>!query.action" method="post" name="queryForm">
	<input name="index" type="hidden" value="${page.index }" />
	<table>
		<tr>
			<td>档案页名称：</td>
			<td><input name="entity.paperName" type="text" value="${entity.paperName }"/></td>
			<td>档案页代码：</td>
			<td><input name="entity.paperType" type="text" value="${entity.paperType }"/></td>
...
<div id="scrollContent" class="table_bor">
	<table class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false">
		<tr>
			...
			<th><span>档案页代码</span></th>
			<th><span>安全级别</span></th>
			<th><span>档案页描述</span></th>
			<th><span>排序</span></th>
		</tr>
		<c:forEach var="entity" items="${list_data}" varStatus="status">
			<tr align="center" >
				...
				<td align="center">&nbsp;${entity.paperName}</td>
				<td align="center">&nbsp;${entity.paperType}</td>
				<td align="center">&nbsp;${levelMap[entity.levelId]}</td>
				<td align="center">&nbsp;${entity.paperDesc}</td>
				<td align="center">&nbsp;${entity.f2 }</td>
			</tr>
		</c:forEach>
