...
String preActoin = "codeSet";
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>代码管理查询列表页面</title>
<%@ include file="/common/meta.jsp"%>
<%@ include file="/common/taglib.jsp"%>
<script language="javascript">
        	function add(){
                var url="<%=path %>/base/codeSet_add.jsp";
        		top.Dialog.open({URL:url,Title:"系统代码添加"});
           	}
            ...
            function update(id){   
                ...
                top.Dialog.open({URL:url,Title:"代码设置修改"});
...
<div id="searchPanel" class="box2" panelTitle="代码设置查询" roller="false">
	...
	<table>
		<tr>
			...
			<td>代码名称：</td>
			<td><input name="entity.name" type="text" value="${entity.name }"/></td>
			<td>代码值：</td>
			<td><input name="entity.code" type="text" value="${entity.code}"/></td>
...
<div id="scrollContent" class="table_bor">
	<table class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false">
		<tr>
			...
			<th><span>代码类别</span></th>
			<th><span>代码值</span></th>
			<th><span>代码名称</span></th>
			<th><span>代码说明</span></th>
		</tr>
		<c:forEach var="entity" items="${list_data}" varStatus="status">
			<tr align="center" >
				...
				<td align="center">&nbsp;
				<c:if test="${entity.type=='1'}">行政区划</c:if>
				<c:if test="${entity.type=='2'}">业务类型</c:if>
				<c:if test="${entity.type=='3'}">号牌种类</c:if>
				</td>
