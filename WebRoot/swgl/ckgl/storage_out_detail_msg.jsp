...
<div id="scrollContent">
	...
	<table class="tableStyle" formMode="view" >
		<tr><th colspan="2">出库信息</th></tr>
		<tr><td width="35%">系统编号：</td><td>${stoout.xtdabh }</td></tr>
		<tr><td>出库批次号：</td><td>${stoout.ckpch }</td></tr>
		<tr><td>储位编号：</td><td>${stoout.cwbh}</td></tr>
		<tr><td>档案编号：</td><td>${stoout.dabh}</td></tr>
		<tr><td>业务类型：</td><td>${vs:ywlxName(stoout.ywlx) }</td></tr>
		<tr><td>流水号：</td><td>${stoout.lsh }</td></tr>
		<tr><td>号牌：</td><td>${stoout.hphm }（${vs:hpzlName(stoout.hpzl)}）</td></tr>
		<tr><td>车辆识别代号：</td><td>${stoout.clsbdh }</td></tr>
		<tr><td>机动车序号：</td><td>${stoout.xh}</td></tr> 
		<tr><td>档案状态：</td><td>${vs:daztName(stoout.dazt) }</td></tr>
		<tr><td>申请人：</td><td>${stoout.sqrxm}（${stoout.sqrid}）</td></tr>
		<tr><td>申请时间：</td><td><fmt:formatDate value="${stoout.sqsj}" type="both" /></td></tr>
		<tr><td>审核人：</td><td>${stoout.shrxm}（${stoout.shrid}）</td></tr>
		<tr><td>出库时间：</td><td><fmt:formatDate value="${stoout.cksj}" type="both" /></td></tr>
