...
<div id="searchPanel" class="box2" panelTitle="查验信息巡查查询" roller="false">
	<form action="<%=preActoin %>!randomQuery.action" method="post" name="queryForm">
	<input name="index" type="hidden" value="${page.index }" />
	<table>
		<tr>		
			<td>巡查比例：</td>
			<td><input id="percent" name="percent" style="width:126px"  value="${percent}"/>&nbsp;&nbsp;%&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
