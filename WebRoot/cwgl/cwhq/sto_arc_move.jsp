...
<html>
  <head>
	...
	function selGuiData(){
		...
		var xtdabh=$("input[name='xtdabh']").val();
		$.post("cwgl/stoget-getMoveTable.action",{"shiId":currShiId,"guiId":currGuiId,"xtdabh":xtdabh},function(data){
			//生成当前位置
  ...
  <body>
  <!-- 当前储位 -->
  <input type="hidden" name="cwbh" value="${cwbh}"/>
  <!-- 系统编号 -->
  <input type="hidden" name="xtdabh" value="${xtdabh}"/>
