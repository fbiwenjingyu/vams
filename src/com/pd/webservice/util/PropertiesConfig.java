...
/**
 * Description : Read configuration file class <p/> 
...
public class PropertiesConfig {
    ...
    private static String CONFIG_FILE = "pd_vams.properties";
	...
	System.out.println(PropertiesConfig.getIntProperty("eas.deploy.position", 0));
	System.out.println(PropertiesConfig.getStringProperty("eas.data.export.path", ""));
