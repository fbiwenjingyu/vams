...
public class FileTools {
	...
	public static final String MENU_ICONS_BASE_PATH = "system/layout/skin/";

	/**
	 * 针对框架的icon获取图片路径列表 /D:/apache-tomcat-6.0.37/webapps/vams/WEB-INF/classes/
	 * */
	public static String[] getMenuIcons() {
		String basePath = FileTools.class.getResource("/").getPath();
		basePath = basePath.substring(1, basePath.length()).split("WEB-INF")[0]
				+ MENU_ICONS_BASE_PATH;
